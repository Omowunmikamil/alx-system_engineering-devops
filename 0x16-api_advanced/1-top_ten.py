#!/usr/bin/python3
"""
Script that returns the numbers of top 10 hot post listed for a given subreddit.
"""
...
def top_ten(subreddit):
    ...
    get_api = requst.get(url, headers=header, params=query_string, allow_redirects=False)
